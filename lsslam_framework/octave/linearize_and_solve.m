...
for eid = 1:length(g.edges)
  ...
  if (strcmp(edge.type, 'P') != 0)
    ...
    foIdx = edge.fromIdx:edge.fromIdx+2;
    toIdx = edge.toIdx:edge.toIdx+2;
    b(foIdx) += A' * edge.information * e; 
    b(toIdx) += B' * edge.information * e;
    H(foIdx,foIdx) += A' * edge.information * A;
    H(toIdx,toIdx) += B' * edge.information * B;
    H(foIdx,toIdx) += A' * edge.information * B;
    H(toIdx,foIdx) += B' * edge.information * A;
